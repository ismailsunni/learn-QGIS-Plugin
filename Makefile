...
# translation
SOURCES = alphaplugins.py ui_alphaplugins.py __init__.py alphapluginsdialog.py
#TRANSLATIONS = i18n/alphaplugins_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = alphaplugins

PY_FILES = alphaplugins.py alphapluginsdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_alphaplugins.py
